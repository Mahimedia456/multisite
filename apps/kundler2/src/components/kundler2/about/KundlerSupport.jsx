        ...
        <div className="rounded-[28px] border border-zinc-200 bg-white overflow-hidden">
          <div className="p-8 sm:p-10">
            ...
            <p className="mt-2 text-zinc-600 max-w-3xl">
              Beratung, Schutz und Vorsorge – passend zu Ihrem Leben. Wir empfehlen,
              Ihre persönliche Situation gemeinsam mit Fachleuten zu besprechen.
            </p>
            ...
            <div className="mt-8 grid md:grid-cols-3 gap-6">
              {POINTS.map((p) => (
                <div key={p.title} className="flex gap-3">
                  ...
                  <div>
                    <div className="font-extrabold text-zinc-900">{p.title}</div>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3">
              <button className="bg-primary hover:bg-primary-dark text-zinc-900 px-6 py-3 rounded-full font-extrabold transition shadow-primary/20">
                Ansprechpartner:in finden
              </button>
              <button className="px-6 py-3 rounded-full font-extrabold border border-zinc-200 hover:bg-zinc-50 transition text-zinc-800">
          ...
          <div className="px-8 sm:px-10 py-5 border-t border-zinc-100 bg-zinc-50 flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="inline-flex items-center gap-2 text-sm font-extrabold text-zinc-900">
              <span className="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center">
                <MIcon name="play_arrow" className="text-primary text-[20px]" />
              </span>
              Kurzvideo
            </div>
          </div>
