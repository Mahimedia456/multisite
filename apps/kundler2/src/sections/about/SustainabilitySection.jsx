...
export default function SustainabilitySection({
  ...
  eyebrow = "Engagement",
  headline = "Nachhaltigkeit & Engagement",
  body = "Verantwortung endet nicht bei unseren Policen. Wir investieren in grüne Energie, fördern soziale Projekte und setzen uns aktiv für den Klimaschutz ein. Weil uns Ihre Zukunft am Herzen liegt.",
  buttonLabel = "Mehr erfahren",
  buttonHref = "/nachhaltigkeit",
}) {
  return (
    <section className="py-24 max-w-[1280px] mx-auto px-6 lg:px-10">
      <div className="rounded-3xl overflow-hidden relative min-h-[400px] flex items-center">
        ...
        <div className="relative p-10 md:p-16 max-w-2xl text-white">
          ...
          <h3 className="text-4xl font-bold mb-6">{headline}</h3>

          <p className="text-gray-200 text-lg mb-8">{body}</p>

          <a
            href={buttonHref}
            className="inline-flex bg-white text-background-dark font-bold px-8 py-3 rounded-lg hover:bg-primary transition-colors"
          >
            {buttonLabel}
          </a>
        </div>
