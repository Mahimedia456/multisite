...
const items = [
  {
    title: "Passende Versicherungen zu Ihrem Bedarf",
          ...
          {[
            {
              ...
              body: "Optimaler Schutz für Ihr Auto – flexibel und zuverlässig.",
            },
            {
              img: x.b,
              title: "Private Haftpflicht",
              body: "Abwehr unberechtigter Forderungen – auch vor Gericht.",
            },
            {
              img: x.c,
              title: "Rechtsschutz",
              body: "Damit Sie Ihr gutes Recht bekommen – inkl. Service-Hotline.",
            },
          ].map((card, i) => (
