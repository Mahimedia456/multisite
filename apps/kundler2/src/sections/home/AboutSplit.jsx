        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-6">
            ...
            <Reveal delay={520}>
              <a
                href={buttonHref}
                className="mt-8 inline-flex h-11 px-6 rounded-xl bg-[#f5c400] text-black font-extrabold text-sm items-center justify-center hover:opacity-90"
              >
                {buttonLabel}
              </a>
            </Reveal>
          ...
          <div className="lg:col-span-6">
            <Reveal delay={120} y={22}>
              <div className="rounded-[2.2rem] overflow-hidden border border-black/5 shadow-sm bg-white">
                <img src={imageSrc} alt="" className="w-full h-[420px] object-cover" />
              </div>
            </Reveal>
          </div>
        </div>
