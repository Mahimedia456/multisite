      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          <Reveal className="lg:col-span-5" y={22}>
            <div className="rounded-3xl overflow-hidden bg-white border border-black/5 shadow-sm">
              <img src={leftSrc} alt="" className="w-full h-72 object-cover" />
            </div>
          </Reveal>

          <Reveal className="lg:col-span-7" delay={80}>
            <div className="rounded-3xl bg-white border border-black/5 shadow-sm p-8 flex flex-col justify-between">
              <div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <a
                  href={primaryHref}
                  className="h-10 px-5 rounded-xl bg-black text-white font-extrabold text-sm hover:opacity-90 inline-flex items-center justify-center"
                >
                  {primaryLabel}
                </a>
                ...
                <a
                  href={secondaryHref}
                  className="h-10 px-5 rounded-xl bg-[#f5c400] text-black font-extrabold text-sm hover:opacity-90 inline-flex items-center justify-center"
                >
                  {secondaryLabel}
                </a>
              </div>
