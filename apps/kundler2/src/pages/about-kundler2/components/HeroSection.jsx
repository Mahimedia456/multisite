      ...
      <div className="relative max-w-[1280px] mx-auto px-6 lg:px-10 w-full">
        <div className="max-w-2xl bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20">
          <h1 className="text-4xl md:text-6xl font-black text-white leading-tight mb-6">
            Über uns – Ihr Partner für eine sichere Zukunft
          </h1>
          <p className="text-lg text-white/90 mb-8">
            Wir begleiten Millionen von Menschen weltweit mit passgenauer Beratung, zuverlässigem Schutz und nachhaltiger Vorsorge.
          </p>
          <button className="bg-primary hover:bg-primary-dark text-text-dark font-bold px-8 py-4 rounded-lg text-lg transition-all transform hover:scale-105">
