      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg mb-8 leading-relaxed">
            Seit Generationen vertrauen Menschen auf die Stärke der Allianz. Wir verstehen uns nicht nur als Versicherer,
            sondern als lebenslanger Begleiter. In einer immer komplexeren Welt schaffen wir die Sicherheit, die Sie für
            Ihre Träume und Pläne brauchen.
          </p>

          <div className="flex items-center gap-4 p-4 bg-primary/10 rounded-lg border-l-4 border-primary">
            <span className="material-symbols-outlined text-primary scale-125">info</span>
            <p className="text-sm font-medium">
              Erfahren Sie in 60 Sekunden, wie wir die Zukunft gestalten.
            </p>
          </div>
        </div>

        <div
          className="relative rounded-2xl overflow-hidden shadow-2xl group cursor-pointer aspect-video bg-gray-200"
        ...
        >
          <div className="absolute inset-0 bg-black/20 flex items-center justify-center transition-colors group-hover:bg-black/40">
            <div className="size-20 bg-primary rounded-full flex items-center justify-center shadow-lg transition-transform group-hover:scale-110">
              <span className="material-symbols-outlined text-text-dark text-4xl fill-1">
                play_arrow
              </span>
            </div>
          </div>
