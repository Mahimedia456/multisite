...
export default function VisiblePage({
  ...
  if (isHidden(type, slug)) {
    return (
      <main className="min-h-screen bg-background-light text-text-dark">
        ...
        <section className="mx-auto flex min-h-[60vh] max-w-3xl flex-col items-center justify-center px-6 text-center">
          <div className="text-xs font-black uppercase tracking-[0.22em] text-text-dark/40">
          ...
          <p className="mt-4 text-base leading-7 text-text-dark/60">
