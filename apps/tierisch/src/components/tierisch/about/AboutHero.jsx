...
export default function AboutHero({
  eyebrow = "Über uns",
  title = "Weil wir Tiere genauso lieben wie Sie.",
  highlight = "lieben",
  description = "Tierisch Gut Versichert steht für verständliche Leistungen, digitale Abläufe und verlässlichen Schutz – damit Tierhalter in Deutschland medizinische Entscheidungen nach dem Tierwohl treffen können, nicht nach dem Preis.",
  primaryLabel = "Unsere Mission",
  primaryHref = "#mission",
  secondaryLabel = "Unsere Reise",
  secondaryHref = "#timeline",
  image = "https://lh3.googleusercontent.com/aida-public/AB6AXuCog2AgjK4UKl1fe1jzKziFR08dQQVgUk6_T6Y5vQbziPZmJQ7i1MYcpPFh7BqPwzq6HJf_ukzVSWYCw5-bNcSRuMTMFeLKTtxxbAvoTE-UORiWoAu3zOdgEx9qbKOUSypb2ZUlNNXsf_wz3MEft_O67CD5IE4I9RWWRXHuuWVnvDuHrrKh_hX8LleaENpciZhtJ_CfUhpbl171bQr4LkDGVEmxElhg_Aw1JqPejf4ylZDYomadWtW3AZ3qvgu2EYqY_x5qoIWzh0A",
}) {
