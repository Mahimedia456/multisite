    ...
    <section id="kontaktformular" className="py-20 bg-[rgb(var(--background))]">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            <h2 className="text-3xl font-extrabold text-zinc-900">{title}</h2>

            <p className="mt-4 text-zinc-600 leading-relaxed">
              {description}
            </p>

            <div className="mt-8 rounded-3xl bg-primary p-8 text-white shadow-[0_12px_24px_rgba(var(--primary),0.25)]">
