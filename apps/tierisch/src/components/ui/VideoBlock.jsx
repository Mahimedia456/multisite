...
export default function VideoBlock({
  title = "Tierkrankenversicherung schnell und einfach erklärt",
  subtitle = "Das Team von Tierisch Gut versichert",
  note = "Kostenlose und unverbindliche Beratung",
  videoSrc = `${ASSET_BASE}/video/our-pet-hospital-final-1.mp4`,
  ...
  return (
    <>
      <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-primary/10 shadow-[0_10px_30px_rgba(2,6,23,0.08)]">
