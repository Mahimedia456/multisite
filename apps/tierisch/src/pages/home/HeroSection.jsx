...
export default function HeroSection({
  title = "Du liebst dein Tier – wir sorgen dafür, dass es bestens geschützt ist.",
  subtitle = "Doch im unübersichtlichen Dschungel der Tierkrankenversicherungen den richtigen Schutz zu finden, ist oft eine Herausforderung.",
  primaryButtonLabel = "Angebot anfordern",
  primaryButtonHref = "#Angebot",
  secondaryButtonLabel = "Über Uns",
  secondaryButtonHref = "#Über",
  badges = ["Versteckte Klauseln", "Wartezeiten und Ausschlüsse", "Unzählige Anbieter"],
  backgroundImage = `${ASSET_BASE}/images/hero-sec.webp`,
}) {
  return (
